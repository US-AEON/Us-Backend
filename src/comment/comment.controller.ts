...
export class CommentController {
  ...
  async getCommentsByPost(
    ...
    const comments = await this.commentService.getCommentsByPost(postId, req.user.uid);
    return {
      success: true,
      message: '댓글 목록 조회 성공',
      data: comments
  ...
  async createComment(
    ...
    const comment = await this.commentService.createComment(postId, createCommentDto, req.user.uid);
    return {
      success: true,
      message: '댓글 생성 성공',
      data: comment
